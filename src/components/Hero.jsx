  ...
  return (
    <section id="home" className="relative h-[80vh] w-full overflow-hidden bg-white">
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6 h-full flex flex-col items-center justify-center text-center">
        <h1 style={{ fontFamily: 'roc-grotesk, sans-serif' }} className="text-4xl md:text-6xl font-semibold text-[#132B4F]">
        ...
        <div className="mt-8 flex items-center gap-3">
          <a href="#solutions" className="px-5 py-2.5 rounded-md bg-[#F4B414] text-[#132B4F] font-medium hover:brightness-95">
            Explore Solutions
          </a>
          <a href="#contact" className="px-5 py-2.5 rounded-md bg-white/80 backdrop-blur border border-[#132B4F]/10 text-[#132B4F] hover:bg-white">
            Talk to Us
          </a>
        </div>
      </div>
